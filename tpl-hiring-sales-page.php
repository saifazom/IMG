<?php
/*
* Template Name: Hiring Sales Page Template 
*/
...
<div id="hr-form" class="o-panel o-panel--hr-form">
   <div class="hr-form">
      <div class="grid-container hr-form__container">
         <div class="hr-form__btn">
            <a  class="u-button" href="<?php echo get_field('hr_button_link') ?>" target="_blank"><?php echo get_field('hr_button_label') ?></a>
         </div>
      </div>
   </div>
